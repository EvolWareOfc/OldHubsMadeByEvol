...
local L_2_ = L_1_:NewWindow('Merge Labubu')
local L_3_ = L_2_:NewSection('Cash')
local L_4_ = L_2_:NewSection('Gems')
local L_5_ = L_2_:NewSection('Labubu')
...
local L_18_ = false
local L_19_ = false
L_5_:CreateToggle('X2 Max Labubu', function(L_43_arg0)
	L_18_ = L_43_arg0
	task.spawn(function()
		while L_18_ do
			local L_44_ = {
...
L_5_:CreateToggle('+10 Labubu', function(L_45_arg0)
	L_19_ = L_45_arg0
	task.spawn(function()
		while L_19_ do
			local L_46_ = {
...
L_5_:CreateToggle('+50 Labubu (Laggy)', function(L_47_arg0)
	L_17_ = L_47_arg0
	task.spawn(function()
		while L_17_ do
			local L_48_ = {
...
L_10_:CreateButton('Max Max Labubu', function()
	local L_69_ = {
		[1] = 'MaxBlocksLevel',
		[2] = 21,
		[3] = 0,
...
-- x2Labubus Potion
local L_25_ = false
L_11_:CreateToggle('x2 Max Labubus', function(L_81_arg0)
	L_25_ = L_81_arg0
	task.spawn(function()
		while L_25_ do
			local L_82_ = {
